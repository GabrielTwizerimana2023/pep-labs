...
public class AverageTest {
    ...
    public void averageTest2(){
        ...
        double target = 1.5;
        double marginOfError = .1;
        Assert.assertEquals(target, a.getAvg1(nums), marginOfError);
    }
    /**
    ...
    public void averageTest3(){
        ...
        double target = 2;
        double marginOfError = .1;
        Assert.assertEquals(target, a.getAvg2(nums), marginOfError);
    }
    /**
    ...
    public void averageTest4(){
        ...
        double target = 0;
        double marginOfError = .1;
        Assert.assertEquals(target, a.getAvg3(nums), marginOfError);
    }
}
